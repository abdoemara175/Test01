...
// ========== COLOR PALETTE TOGGLE & SELECTION ==========
const colorPickerBtn = document.getElementById('colorPickerBtn');
const colorPickerMenu = document.getElementById('colorPickerMenu');
const colorOptions = document.querySelectorAll('.color-option');
const savedColor = localStorage.getItem('portfolio-color-theme') || 'blue';
...
colorOptions.forEach(option => {
  option.addEventListener('click', () => {
    ...
    localStorage.setItem('portfolio-color-theme', selectedColor);
...
// ========== NAVBAR SCROLL BEHAVIOR & SCROLL SPY ==========
...
window.addEventListener('scroll', () => {
  ...
  if (window.scrollY > heroHeight - 100) {
    ...
    // Clear active states when scrolled back to hero
...
sections.forEach(section => {
  ...
  if (section.getAttribute('id') && section.getAttribute('id') !== 'hero') {
